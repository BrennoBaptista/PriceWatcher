...
- Coleta roda a cada 8 horas sem falhar silenciosamente.
- Quando um anúncio bate o menor preço já visto, o alerta chega em até 8h.
...
| Cooldown | Máximo 1 alerta `new_low` por produto a cada 8h | Evita repetição entre rodadas próximas. Acompanha o intervalo de coleta: um cooldown maior que o intervalo silenciaria rodadas inteiras |
...
- Padrão: `00:00`, `08:00` e `16:00` no fuso `America/Sao_Paulo`.
...
```yaml
schedule:
  times: ["00:00", "08:00", "16:00"]   # a cada 8 horas
  jitter_minutes: 15
...
alerts:                                  # defaults globais
  new_low:
    ...
    cooldown_hours: 8       # acompanha o intervalo de coleta
  back_in_stock:
    enabled: true
    cooldown_hours: 24
```
